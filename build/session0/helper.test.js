"use strict";
var _a = require('chai'), assert = _a.assert, expect = _a.expect;
var helper = require('./helper');
describe('bytes', function () {
    var bytes = helper.strToBytes('hello world', 'ascii');
    var str = helper.bytesToString(bytes, 'ascii');
...
describe('little endian to int', function () {
    var bytes = helper.strToBytes('99c3980000000000', 'hex');
    var want = 10011545;
    it('le1', function () {
...
describe('int to little endian', function () {
    var n = 1;
    var buf = helper.intToLittleEndian(n, 4);
    var want = Buffer.from([0x01, 0x0, 0x0, 0x0]);
    it('le', function () {
